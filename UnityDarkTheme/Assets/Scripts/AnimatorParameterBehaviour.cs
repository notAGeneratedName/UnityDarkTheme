...
public class AnimatorParameter
{
    ...
    {
        public override float GetPropertyHeight(SerializedProperty property, GUIContent label) => property.isExpanded ? 45 : 15;
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            position.height = 15;
            if (!(property.isExpanded = EditorGUI.Foldout(position, property.isExpanded, property.displayName, true))) return;
            position.x += 15;
            position.y += 15;
